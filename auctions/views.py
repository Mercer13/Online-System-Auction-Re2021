...
from .models import Bid, Comment, Category, Listing, WatchList 
from .utils import find_max_bid , find_winning_bids, uah
    ...
    for listing in otherlistings_closed:
        ...
        if bids: 
            ...
            if winning_bid_id[0].user_id == user:
                otherlistings_won.append({"id": listing.id, "title": listing.title, "bid": uah(listing.bid),
...
def watchlist(request, user_id):
    ...
    for listing in watchlist:
        listing.listing_id.bid = uah(listing.listing_id.bid)
